...
Dokumen ini mendefinisikan struktur standar Bagan Akun (_Chart of Accounts_), saldo normal, mekanisme jurnal pembuka, serta formula pembentukan jurnal otomatis pada operasional apotek.
...
## 2. Logika Saldo Awal (_Opening Balance Engine_)
...
4. Setelah divalidasi dan disimpan, sistem otomatis mengunci (_Lock Period_) dan membentuk **Jurnal Pembuka**.
...
Ketika tombol _"Generate Jurnal"_ diklik pada baris rekap harian:
